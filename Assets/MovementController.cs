...
public class MovementController : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (Input.GetKeyDown("w"))                                      //increment speed
		{
			speed += 5f;
		}
		else if (Input.GetKeyDown("s"))                                 //decrement speed
		{
			speed -= 5f;
		}
		else if (Input.GetKeyDown("e"))                                 //increment rotation
		{
